...
function App() {
  ...
  const addToComponent = (item) => {
    ...
    // Initialize tempList if it doesn't exist
    if (!tempList) {
      tempList = [];
    }
  ...
  return (
    <div className="bg-amber-100 min-h-screen p-6">
      ...
      <div className="flex flex-wrap justify-evenly items-start border-t-2 border-black py-4 mt-4">
        <div className="min-w-[350px] min-h-72">
        ...
        <div className="min-w-[350px] min-h-72" ref={drop} style={{ backgroundColor: isOver ? '#e0e7ff' : 'transparent' }}>
